...
class Flow(object):
    ...
    def __init__(self,design,default_foundry,default_track,default_corner,default_flow_flag):
        self.design             = design
        self.default_foundry    = default_foundry
        self.default_track      = default_track
        self.default_corner     = default_corner
        self.default_flow_flag  = default_flow_flag

        if self.default_flow_flag == 'iEDA' :
            self.step           = ('synth','floorplan','fix_fanout','place','cts','fix_drv','opt_hold','pl_legalize','route','filler','sta','layout')
            self.tool           = {
                'synth'       :   'yosys_0.9'         ,
                'floorplan'   :   'iEDA_0.1'          ,
                'fix_fanout'  :   'iEDA_0.1'          ,
